...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, AgentList, AgentLogs,UnassignedReports,AssignedReports,ConsultarDenuncia, EstadisticasDeAbuso,RealizarDenunciaComponent,RecursosDeAyuda], // Agregamos AgentListComponent aquí
  styleUrl: './app.css',
